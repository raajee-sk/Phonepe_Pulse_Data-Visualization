...
# ---------   /   All India Transaction Analysis   /  ----- #      
    with tab1:
        ...
        cur.execute(f"SELECT State, Transaction_count, Transaction_amount FROM aggregated_transaction WHERE Year = '{trans_yr}' AND Quarter = '{trans_qtr}' AND Transaction_type = '{trans_type}'order by Transaction_amount desc;")
